...
## Objetivo
Varias vías de patrocinio/publicidad en Murcia en exploración, ninguna cerrada todavía.

## Real Murcia CF (cantera)
- Propuesta del club: 45.000€+IVA. Contraoferta formalizada por MPC (16 jul): 30.000€+IVA.
- **Confirmado en 30.000€+IVA** (24 jul 2026) — 10.000€ ya ejecutados en el primer semestre, resto pendiente de ejecutar en lo que queda de año.
...
- **FIRMADO (17 ago 2026).** Logo de cantera en el pantalón: parte delantera, pierna izquierda. Pendiente confirmar si se plantearon al club los riesgos de contrato detectados el 13/08 antes de firmar.
...
## Ideas sin explorar (candidatas futuras)
