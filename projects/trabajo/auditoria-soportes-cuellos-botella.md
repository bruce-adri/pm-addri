...
## Objetivo
Iniciativa de Manuel (20 ago 2026, por email): establecer un proceso de auditoría continua y periódica de los soportes públicos (landing, web, textos on/off line, en todos los idiomas), con repositorio encriptado revisado por Calidad. En paralelo, identificar y resolver cuellos de botella operativos que dependen en exceso de personas concretas (menciona explícitamente a Eduardo), avanzando hacia mejor distribución del conocimiento, responsabilidades definidas y procedimientos documentados que no dependan de la disponibilidad de nadie en particular.

## Estado (20 ago 2026)
Bruce redactó una respuesta para Adrián:
- Marketing lidera la revisión periódica de soportes (diseño + contenido), con validación final de Calidad.
